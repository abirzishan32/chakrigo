...
import { SocketProvider } from "@/components/context-providers/SocketProvider";
import { NotificationProvider } from "@/components/context-providers/NotificationProvider";
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            >
                                <div className="relative w-6 h-6 flex items-center justify-center">
                                    ...
                                    <div
                                        className={`absolute inset-0 rounded-full border border-primary-100/30 transition-all duration-300 ${
                                            isMenuOpen
...
const NavLink = ({ href, label }: { href: string; label: string }) => (
    <Link href={href} className="relative nav-item-hover nav-link-underline">
