    ...
    return {
        ...
        "services": {
            "ai_animation": {
                ...
                "features": ["Avatar generation", "Animation creation", "Media management"]
            },
            "system_design": {
                "description": "Generate system architecture diagrams and explanations",
                "endpoints": ["/system-design/generate", "/system-design/generate-stream", "/system-design/health"],
                "features": ["PlantUML diagrams", "Architecture analysis", "Streaming generation"]
            },
            "roadmap_generation": {
                "description": "Generate career learning roadmaps and guides",
                "endpoints": ["/roadmap/generate", "/roadmap/generate-stream", "/roadmap/health", "/roadmap/examples"],
                "features": ["Career analysis", "Interactive roadmaps", "Learning resources", "Progress tracking"]
            }
        },
        "common_features": [
            "Streaming responses",
...
async def get_service_status():
    ...
    try:
        ...
        status["services"]["roadmap_generation"] = {
            "status": "healthy",
            "features": ["Career analysis", "Interactive roadmaps", "React Flow", "Streaming"]
        }
    except Exception as e:
        status["services"]["roadmap_generation"] = {
            "status": "error",
